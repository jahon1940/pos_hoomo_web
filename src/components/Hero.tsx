    ...
    <section className="bg-white py-10 md:py-20 relative overflow-hidden pb-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-20 lg:mb-0">
          {/* Top Left Image */}
          <AnimatedCard
            className="col-span-6 md:col-span-3 absolute top-0 -left-30 w-80 h-52 hidden lg:block"
            delay={0.1}
          >
            <div className="w-full h-full rounded-2xl shadow-lg overflow-hidden">
              <img
                className="w-full h-full object-cover"
                src="https://billz.io/_next/image?url=https%3A%2F%2Fbillzwp.billz.work%2Fwp-content%2Fuploads%2F2022%2F06%2F1-1.webp&w=1920&q=75"
                alt=""
              />
            </div>
          </AnimatedCard>
          ...
          {/* Top Right Image */}
          <AnimatedCard
            className="col-span-6 md:col-span-3 absolute top-0 -right-30 w-80 h-52 hidden lg:block"
            delay={0.1}
          >
            <div className="w-full h-full rounded-2xl shadow-lg overflow-hidden">
              <img
          ...
          {/* Bottom Left Image */}
          <AnimatedCard
            className="col-span-6 md:col-span-3 absolute bottom-10 -left-10 w-80 h-48 hidden lg:block"
            delay={0.5}
          >
          ...
          {/* Bottom Middle Image */}
          <AnimatedCard
            className="col-span-6 md:col-span-3 absolute -bottom-30 left-1/2 transform -translate-x-1/2 w-90 h-56 hidden lg:block"
            delay={0.5}
          >
          ...
          {/* Bottom Right Image */}
          <AnimatedCard
            className="col-span-6 md:col-span-3 absolute bottom-10 -right-10 w-80 h-48 hidden lg:block"
            delay={0.5}
          >
          ...
          <AnimatedSection
            className="text-center pt-0 md:pt-10 pb-0  lg:pb-32"
            delay={0.2}
          >
            <motion.h1
            ...
            >
              <motion.button
                className="bg-primary text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-colors flex items-center"
        ...
        {/* Mobile Images Grid */}
        <AnimatedSection
          className="lg:hidden grid grid-cols-6 md:grid-cols-6 gap-4 max-w-4xl mx-auto mb-12 w-full"
          delay={0.4}
        >

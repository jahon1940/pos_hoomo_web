        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <AnimatedCard key={index} delay={index * 0.1}>
              ...
              >
                <motion.div 
                  className={`inline-flex p-3 rounded-lg ${getColorClasses(feature.color)} mb-6`}
                ...
                >
                 ...
                 <img className='rounded-4xl group-hover:scale-105 transition-all duration-300' src={feature.image} alt="" />
              </motion.div>
